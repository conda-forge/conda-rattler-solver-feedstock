...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/conda-rattler-solver-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/conda-rattler-solver-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add conda-rattler-solver
# for installing globally
pixi global install conda-rattler-solver
```
...
It is possible to list all of the versions of `conda-rattler-solver` available on your platform:
...
```
pixi search conda-rattler-solver --channel conda-forge
```
